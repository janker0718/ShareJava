  ...
  <aside class="page-sidebar">
   ...
   <FullScreenBtn />
      ...
      <div class="option-box-toc-over" v-on:mouseover="showTocOver($event)" v-on:mouseout="hideTocOver($event)">
        <img src="/images/system/mulu.png" class="nozoom" />
        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img v-bind="{src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://www.share-java.com'+this.$route.fullPath }" height="180px" style="margin:10px;"/>
   ...
   <!--            <div class="icon-arrow"></div> -->
   <!--            <div class="scroll-box" style="text-align:center" > -->
   <!--              <span style="font-size:0.8rem;font-weight:bold;">添加xxx微信<span style="color:red;">(share-java)</span>进学习交流圈「无任何套路」</span> -->
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        ...
        <div class="toc-container">
            <div class="pos-box">
              <div class="icon-arrow"></div>
              <div class="scroll-box" style="text-align:center" >
                <span style="font-size:0.8rem;font-weight:bold;">扫描公众号，回复<span style="color:red;">“66”</span>下载<span style="color:red;">1TB+</span>学习技术资料、PDF书籍、简历模板「无任何套路」</span>
                <img src="https://cdn.jsdelivr.net/gh/janker0718/image_store/img/20220103214503494.png" height="180px" style="margin:10px;"/>
                <b>公众号:</b> 爪哇干货分享
              </div>
            </div>
        </div>
...
<!--                <img height="180px" src="/images/system/heart-1.png" style="margin:5px;"/>-->
      ...
      <div class="option-box" v-on:mouseover="showSitemap($event)" v-on:mouseout="hideSitemap($event)">
        ...
        <div class="sitemap-container">
            <h4>站点导航图
              ...
              <router-link class="sitemap-top-link" key="/md/about/me/about-arch.html" to="/md/about/me/about-arch.html" > 关于学习</router-link>
            </h4>
            <SiteMap />
        </div>
      </div>
